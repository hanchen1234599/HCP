...
namespace CommonData
{
    ...
    class BaseNetTcp
    {
        ...
        {
            Console.WriteLine("basenettcp onConnect");
        ...
        {
            Console.WriteLine("basenettcp send");
            ...
            if (bytesRead > 0)
            {
                ...
                while (haveRead <= totalLen)
                {
                    ...
                    else
                    {
                        ...
                        if (bodySize >= 0)
                        {
                            Proto.BaseData bd = Proto.BaseData.Parser.ParseFrom(surplusBuffer, haveRead + headSize, bodySize);
